...
{
    public delegate Character GenerateActorReceiver(PackedScene packedScene, Vector2 position, Vector2 movePoint, float height = 0, float heightSpeed = 0, Prop[] props = null);
