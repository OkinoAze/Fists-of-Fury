...
public partial class PropChicken : Prop
{
    enum State
    {
        Idle,
    ...
    {
        PropChicken character;
        public int GetId { get; } = (int)State.Idle;
        public StateIdle(PropChicken c)
        {
            character = c;
    ...
    partial class StateFall : Node, IState
    {
        ...
        public StateFall(PropChicken c)
        {
            character = c;
            character.States[GetId] = this;
        }
    ...
    partial class StateDestroyed : Node, IState
    {
        ...
        public StateDestroyed(PropChicken c)
        {
            character = c;
            character.States[GetId] = this;
        }
